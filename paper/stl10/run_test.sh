...
test_args=(
  ...
  --nepochs   5         # Enough epochs to show convergence trend
  --lr 0.05
  --momentum 0.9
  --weight_decay 5e-4
  --test_freq 1         # Test every epoch to get 5 data points
  --width 128
)
...
echo "  - Epochs: 5 (vs 100+ in production runs)"
...
echo "Expected output: 5 validation points per experiment"
echo ""
