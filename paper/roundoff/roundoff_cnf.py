...
def main():
    ...
    parser.add_argument('--checkpoint', type=str,
                       default='/local/scratch/lruthot/code/rampde/results/raw_data/cnf/2spirals_float32_torchdiffeq_rk4_lr_0.01_niters_2000_num_samples_1024_hidden_dim_32_width_128_num_timesteps_128_seed42_20250805_152738/ckpt.pth',
